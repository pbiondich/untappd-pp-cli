...
but do not stop the import.`,
  ...
  untappd-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  untappd-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | untappd-pp-cli import <resource> --input -`,
