...
import (
	...
	"github.com/pbiondich/untappd-pp-cli/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"untappd-pp-cli auth login",
		"untappd-pp-cli doctor",
		"untappd-pp-cli help items",
		"untappd-pp-cli sync",
		"untappd-pp-cli profile list",
		"untappd-pp-cli feedback list",
		"untappd-pp-cli which",
		"untappd-pp-cli agent-context",
		"untappd-pp-cli completion bash",
		"untappd-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"untappd-pp-cli recall",
		"untappd-pp-cli learnings",
		"untappd-pp-cli teach-pattern",
		"untappd-pp-cli teach-lookup",
		"untappd-pp-cli items list",
	}
